...
\vfill
\begin{abstract}
    En este trabajo práctico, resolveremos problemas de optimización, aplicando diferentes técnicas 
    algorítmicas (como \textit{backtracking}, \textit{algoritmos golosos}, \textit{podas} en árboles, etc). 
    Luego, realizaremos diferentes análisis teóricos sobre la complejidad 
    y correctitud de los mismos. \medskip
    
    Finalmente pondremos nuestros algoritmos a prueba en diferentes escenarios, ilustrando con gráficos 
