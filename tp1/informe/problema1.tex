...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item $c = 2$, con un patrón de tablones sano - roto - sano, como se puede ver en la figura 4.
...
En este test, fijamos el valor de $n$ (cantidad de tablones) en 100000, mientras que el valor de $c$ se generó 
aleatoriamente, con valores entre 100 y 100000, incrementándose de a 100.
...
En este gráfico podemos apreciar que, a pesar de que generamos los valores de $c$ de manera aleatoria, la complejidad 
se mantiene constante. Por este motivo, concluímos que el algoritmo y la implementación excogida para resolver este 
problema son tales que la complejidad de los mismos es \textbf{independiente} de $c$ y queda reforzado el análisis 
teórico desarrollado anteriormente, donde veíamos que se trataba de un algoritmo lineal.
