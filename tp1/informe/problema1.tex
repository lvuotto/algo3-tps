\subsection{1.1. Descripción del problema.}
...
\subsection{1.2. Desarrollo de la idea y pseudocódigo.}
...
\subsection{1.3. Justificación de la resolución y demostración de correctitud.}
...
\textbf{Demostración (\textsc{esPosibleCruzar}):} 
  ...
  La función \textsc{esPosibleCruzar} mantiene un \textbf{contador de tablones rotos consecutivos},
...
\textbf{Absurdo}, que vino de suponer que existía una solución cuando la cantidad de
tablones rotos consecutivos es igual o mayor al salto máximo.

\textbf{La vuelta:}
Sea un puente de $n$ tablones con salto máximo $c$ y $k$ la cantidad máxima de
...
\subsection{1.4. Análisis de complejidad.}

\vspace*{0.3cm}

Para el análisis de complejidad nos basaremos en el pseudocódigo del punto \textbf{1.2}.
...
\subsection{1.5. Partes relevantes del código (hacer referencia al apéndice).}
...
\subsection{1.6. Experimentación y gráficos.}
